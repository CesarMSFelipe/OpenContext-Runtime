...
See [Installation Experience](installation-experience.md) for the agentic workflow tool-style setup target: select agents, choose TDD mode, create SDD artifacts, configure clients, and index the graph in one wizard run.
