...
## Purpose
The novelty gate scores novelty, reuse likelihood, source trust, token cost, classification risk, staleness, and duplication. Duplicate, trivial, stale, too-sensitive, or no-provenance memory is rejected.
