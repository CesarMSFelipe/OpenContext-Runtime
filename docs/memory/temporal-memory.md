...
## Purpose
Temporal memory facts include subject, predicate, object, validity range, supersession, source id, confidence, and classification. Superseded facts are not active by default.
