...
## Purpose
Memory GC moves expired and superseded items to archive. Future criteria include low reuse, missing source, duplicate content, retention windows, and sensitivity policy.
